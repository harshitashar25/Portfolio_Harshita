...
const Skills = () => {
  const skillCategories = [
    {
      ...
      icon: <Layout className="text-[#ADEBFF]" size={24} />,
      skills: [
    ...
    },
    {
      ...
      icon: <Server className="text-[#ADEBFF]" size={24} />,
      skills: [
    ...
    {
      category: 'Database',
      icon: <Database className="text-[#ADEBFF]" size={24} />,
      skills: [
    ...
    },
    {
      ...
      icon: <Code className="text-[#ADEBFF]" size={24} />,
      skills: [
    ...
    {
      category: 'Design',
      icon: <Brush className="text-[#ADEBFF]" size={24} />,
      skills: [
  ...
  return (
    <section id="skills" className="py-20 bg-[#00171F] text-white">
      <div className="container mx-auto px-4">
        <h2 className="text-3xl font-bold mb-2 text-center text-[#ADEBFF]">Technical Skills</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {skillCategories.map((category, index) => (
            <Card key={index} className="overflow-hidden animate-fade-in bg-[#00171F] border border-[#ADEBFF]/20" style={{animationDelay: `${index * 0.1}s`}}>
              <CardContent className="p-6">
                <div className="flex items-center gap-2 mb-4">
                  {category.icon}
                  <h3 className="text-xl font-semibold text-[#ADEBFF]">{category.category}</h3>
                </div>
                  ...
                  {category.skills.map((skill, skillIndex) => (
                    <div key={skillIndex}>
                      <div className="flex justify-between mb-1">
                        ...
                        <span className="text-[#C2E6FF]">{skill.proficiency}%</span>
                      </div>
                      <div className="w-full h-2 rounded bg-[#002B3A]">
                        <div
                          className="h-full rounded bg-[#ADEBFF]"
